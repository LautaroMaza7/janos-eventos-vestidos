...
import {AiOutlineHome, AiFillShopping, AiFillPicture, AiFillMessage} from 'react-icons/ai'
...
export const links = [
    {id: 1, link: '/', title: <AiOutlineHome/>},
    {id: 2, link: '#programs', title: <AiFillShopping/>},
    {id: 3, link: '/', title: <AiFillPicture/>},
    {id: 4, link: '/', title: <AiFillMessage/>}
]
...
export const programs = [
    {
        id: 1,
        image: Image1,
        title: "Vestido de Casamiento",
        path: '/detail1',
        info: "Provident similique accusantium nemo autem. Veritatis obcaecati tenetur.",
